...
def create_test_image_base64():
    """Create a valid test image in base64 format using PIL"""
    try:
        # Create a simple test image that looks like a pill
        img = Image.new('RGB', (200, 200), color='white')
        draw = ImageDraw.Draw(img)
        
        # Draw a simple oval shape to simulate a pill
        draw.ellipse([50, 80, 150, 120], fill='lightblue', outline='blue')
        draw.text((75, 95), 'TEST', fill='black')
        ...
        # Fallback to a simple valid JPEG header
